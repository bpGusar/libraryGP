const MSG = {
  ...
  youHaveMaxQuantityOfBooksOnYourHands: {
    ru:
      "Вы не можете забронировать больше книг. Максимальное количество книг забронированных и на руках, в сумме, не может превышать пять книг."
  },
  postInBlogAdded: {
    ru: "Запись в блог добавлена успешно."
  },
  cantAddBlogPost: {
    ru: "Произошла ошибка при добавлении записи в блог."
  }
};
