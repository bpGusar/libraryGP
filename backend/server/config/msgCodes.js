const MSG = {
  ...
  userFoundButNotVerified: {
    ru:
      "Пользователь с такими данными зарегистрирован но не подтвердил email адрес. Если это вы, то проверьте свою почту. Если почту не подтвердить то через 3 дня после регистрации аккаунт будет удален. Если вы видите это сообщение значит аккаунт еще существует."
  },
  bookOutOfStock: {
